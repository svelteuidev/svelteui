...
const Home = () => {
	return (
		<>
			...
			<Head>
				<title>
					SvelteUI - A variety of components, actions, transition and utility functions!
				</title>
			</Head>
							...
							<div className="col-span-12 lg:col-span-6 ">
								<div className="text-center lg:text-left md:max-w-2xl md:mx-auto ">
									<h1 className="text-4xl tracking-tighter leading-10 font-black text-gray-900 sm:leading-none sm:text-6xl lg:text-5xl xl:text-6xl">
										Create fully functional and accessible web applications in less time than ever
										before.
										<br className="inline" />
										<span className="gradient-animation">Regardless of design experience</span>
									</h1>
									<p className="mt-3 text-base text-gray-900 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl font-semibold">
										A Svelte library with a variety of components, actions, transition and utility
										functions!
									</p>
								...
								<div>
									<div>
										...
										<p className="mt-2 lg:mt-4 text-base xl:text-lg lg:leading-normal leading-6 text-gray-600">
											Build type safe applications. All SvelteUI packages are built with TypeScript
											and support it by default. All components and functions export types, are
											documented, and give developers autocomplete features!
										</p>
									</div>
								</div>
								<div className="mt-10 lg:mt-0">
									<div>
										...
										<p className="mt-2  lg:mt-4 text-base xl:text-lg lg:leading-normal leading-6 text-gray-600">
											...
											best-in-class developer experience. Colors, fonts, shadows and many other
											parts are customizable to fit your design needs.
										</p>
									</div>
								</div>
								<div className="mt-10 lg:mt-0">
									<div>
										...
										<p className="mt-2  lg:mt-4 text-base xl:text-lg lg:leading-normal leading-6 text-gray-600">
											All components are accessible according to WAI-ARIA standards. On top of that,
											no annoying focus ring. It will appear only when user navigates with keyboard
										</p>
									</div>
								</div>
							</div>
				...
				<div className="bg-gray-100 relative py-24 border-t border-gray-200 ">
					<div className="px-4 sm:px-6 lg:px-8  mx-auto container max-w-3xl sm:text-center">
						...
						<p className="my-4 text-xl leading-7  text-gray-600">
							Instead of remaking the same components, recreating custom actions, transitions,
							utilities, etc. You could simplify your workflow by using things already made and
							ready to go. Accessibility, attractive styles, and more is handled for you, so you can
							start making projects quickly. Don't like what you see? Customize every component
							anyway you like!
						</p>
					</div>
					<div
					...
					<div className="py-24 px-4 sm:px-6 lg:px-8  mx-auto container">
						<div className=" sm:text-center pb-16">
							...
							<p className="mt-4 text-xl max-w-3xl mx-auto leading-7 text-gray-300">
								With Stitches as the only dependency, SvelteUI is extremely lean, and will be packed
								with features you'll almost certainly need in most projects.
							</p>
						</div>
						<div>
