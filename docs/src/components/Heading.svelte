...
<Stack override={{ width: 'max-content' }}>
  <Stack override={{ mb: 20, h1: { mb: 0 } }} spacing="xs">
  ...
  {#if $current_page.meta?.source}
    <Group spacing={65}>
      ...
      <Text
        variant="link"
        root="a"
        href={`${links.github}${$current_page.meta.source}`}
      >
  ...
  {#if $current_page.meta?.docs}
    <Group spacing={78}>
      ...
      <Text
        variant="link"
        root="a"
        href={`${links.github}${$current_page.meta.docs}`}
      >
        <Center override={{ gap: '$4' }} inline>
          <Pencil1 />
          Edit This Page
  ...
  {#if $current_page.meta?.packageGroup}
    <Group spacing={55}>
      ...
      <Text
        variant="link"
        root="a"
        href={`${links.npm}${$current_page.meta.packageGroup}`}
      >
        <Center override={{ gap: '$4' }} inline>
          <Cube />
