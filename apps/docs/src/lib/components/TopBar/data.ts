...
export const searchLinks = [
  ...
  { title: "use-browser-context", link: `${base}/composables/use-browser-context`, section: "Composables" },
  { title: "use-click-outside", link: `${base}/composables/use-click-outside`, section: "Composables" },
  { title: "use-clipboard", link: `${base}/composables/use-clipboard`, section: "Composables" },
  { title: "use-css-variable", link: `${base}/composables/use-css-variable`, section: "Composables" },
  ...
  { title: "use-element-size", link: `${base}/composables/use-element-size`, section: "Composables" },
  { title: "use-eye-dropper", link: `${base}/composables/use-eye-dropper`, section: "Composables" },
  { title: "use-focus-within", link: `${base}/composables/use-focus-within`, section: "Composables" },
  ...
  { title: "use-mouse-position", link: `${base}/composables/use-mouse-position`, section: "Composables" },
  ...
  { title: "use-persistent-tab", link: `${base}/composables/use-persistent-tab`, section: "Composables" },
  ...
  { title: "use-viewport-size", link: `${base}/composables/use-viewport-size`, section: "Composables" },
  ...
  { title: "SvelteUI Preprocessors", link: `${base}/preprocessors/getting-started-preprocessors`, section: "Preprocessors"},
