...
<Template>
	{#snippet children({ args })}
		<Tabs {...args}>
			<Tabs.Tab labelText="Gallery" iconComponent={Camera}>
			...
			<Tabs.Tab labelText="Messages" iconComponent={EnvelopeClosed}>
				...
				<Text
					...
					Duis arcu tortor, suscipit eget, imperdiet nec, imperdiet iaculis, ipsum. Sed aliquam
					...
					non, auctor et, hendrerit quis, nisi.</Text
				>
			</Tabs.Tab>
...
<Story name="Nested Tabs" id="nestedTabsStory">
	<Tabs>
		<Tabs.Tab labelText="Gallery">
			<Tabs>
				<Tabs.Tab labelText="Photos">Photos tab content</Tabs.Tab>
				<Tabs.Tab labelText="Images">Images tab content</Tabs.Tab>
			</Tabs>
		</Tabs.Tab>
		<Tabs.Tab labelText="Messages">Messages tab content</Tabs.Tab>
	</Tabs>
</Story>
