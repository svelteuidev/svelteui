<script lang="ts">
	...
	import type { BoxNewProps as $$BoxNewProps } from './BoxNew';

	interface $$Props extends $$BoxNewProps {}
	...
	// TODO: workaround for root type errors, this should be replaced by a better type system
	...
	// TODO(migration): perhaps we can even remove box and move this to a function?
