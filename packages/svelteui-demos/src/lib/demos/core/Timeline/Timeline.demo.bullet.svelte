...
<Center>
	...
	export const configuration: ConfiguratorDemoConfiguration = {
		...
		configurator: [
            ...
            { name: 'reverseActive', label: 'Reverse active', type: 'boolean', initialValue: false, defaultValue: false },
            { name: 'lineWidth', label: 'Line width', type: 'number', initialValue: 4, min: 1, max: 8 },
            { name: 'bulletSize', label: 'Bullet size', type: 'number', initialValue: 20, min: 12, max: 30 },
			{
				name: 'align',
				type: 'select',
				data: [
...
<Center>
    <Timeline {...props}>
        ...
        <Timeline.Item title='Commits'>
            <Text color='dimmed' size='sm' align={props.align}>You&apos;ve pushed 23 commits to<Text variant='link' root='span' href='#' inherit
                    >fix-notifications branch</Text
                ></Text
            >
        ...
        <Timeline.Item title='Pull request' lineVariant='dashed'>
            <Text color='dimmed' size='sm' align={props.align}>You&apos;ve submitted a pull request<Text variant='link' root='span' href='#' inherit
                    >Fix incorrect notification message (#187)</Text
                ></Text
            >
        ...
        <Timeline.Item title='Code review'>
            <Text color='dimmed' size='sm' align={props.align}><Text variant='link' root='span' href='#' inherit>Robert Gluesticker</Text> left a code review on
                your pull request</Text
            >
