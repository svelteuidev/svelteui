...
<Skeleton height={8} mt={6} radius="xl" override={{ marginTop: '8px' }} ${props} />
<Skeleton height={8} mt={6} width="70%" radius="xl" override={{ marginTop: '8px' }} ${props} />
`;
...
<script lang="ts">
	...
	import { Center, Skeleton } from '@svelteuidev/core';
