...
<Notification icon={Check} ${props}>
	...
	export const configuration: ConfiguratorDemoConfiguration = {
		...
		configurator: [
            ...
            { name: 'children', label: 'Content', type: 'string', initialValue: 'That you are now obligated to give feedback on SvelteUI on GitHub' },
			{
				name: 'color',
				type: 'color',
				initialValue: 'blue',
			...
			{ name: 'withCloseButton', label: 'With close button', type: 'boolean', initialValue: true, defaultValue: true }
		]
	};
</script>
